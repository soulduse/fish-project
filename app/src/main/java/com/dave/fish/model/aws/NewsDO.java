package com.dave.fish.model.aws;
...
@DynamoDBTable(tableName = "fishproject-mobilehub-1822007876-News")
...
public class NewsDO {
    ...
    public void setIsDeleted(final Boolean _isDeleted) {
    ...
    public void setUpdateDate(final Double _updateDate) {
