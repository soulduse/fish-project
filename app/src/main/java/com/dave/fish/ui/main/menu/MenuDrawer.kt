...
enum class MenuDrawer(val title : String, val icon : Int) {
    INFO("물때&날씨", R.drawable.ic_menu_invert),
    MAP("지도&기록", R.drawable.ic_menu_edit_location),
    KWEATHER("국내예보", R.drawable.ic_toys_white_24dp),
    FWEATHER("해외예보", R.drawable.ic_toys_white_24dp),
    ALARM("알림설정", R.drawable.ic_menu_notifications),
    TIP("해루질팁", R.drawable.ic_menu_info),
